...
public class MavenUtils {
    ...
    public static Path resolveArtifact(Path basedir, String coords) {
        ...
        System.out.printf("Resolving artifact %s from %s%n", request.getArtifact(), request.getRepositories());
        ...
        try {
            ...
            System.out.printf("Resolved artifact %s to %s from %s%n", artifact, file, repository);
            return file.toPath();
