...
public class InnerClassInfo implements Diffable<InnerClassInfo> {
    ...
    public boolean equals(Object o) {
        ...
        InnerClassInfo that = (InnerClassInfo) o;
        return access == that.access && Objects.equals(innerName, that.innerName) && name.equals(that.name) && Objects.equals(outerName, that.outerName);
    }
